...
*MyCharactersApi* | [**action_christmas_exchange_my_name_action_christmas_exchange_post**](docs/MyCharactersApi.md#action_christmas_exchange_my_name_action_christmas_exchange_post) | **POST** /my/{name}/action/christmas/exchange | Action Christmas Exchange
