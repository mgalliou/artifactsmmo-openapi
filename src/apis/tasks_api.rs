...
pub fn get_tasks_reward_tasks_rewards_code_get(configuration: &configuration::Configuration, code: &str) -> Result<models::TasksRewardResponseSchema, Error<GetTasksRewardTasksRewardsCodeGetError>> {
    let local_var_configuration = configuration;
