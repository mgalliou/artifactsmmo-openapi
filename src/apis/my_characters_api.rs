...
/// Complete a task.
pub fn action_complete_task_my_name_action_task_complete_post(configuration: &configuration::Configuration, name: &str) -> Result<models::TasksRewardDataResponseSchema, Error<ActionCompleteTaskMyNameActionTaskCompletePostError>> {
    let local_var_configuration = configuration;
...
pub fn action_task_exchange_my_name_action_task_exchange_post(configuration: &configuration::Configuration, name: &str) -> Result<models::TasksRewardDataResponseSchema, Error<ActionTaskExchangeMyNameActionTaskExchangePostError>> {
    let local_var_configuration = configuration;
