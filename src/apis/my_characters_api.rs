...
/// struct for typed errors of method [`action_christmas_exchange_my_name_action_christmas_exchange_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActionChristmasExchangeMyNameActionChristmasExchangePostError {
    Status498(),
    Status499(),
    Status486(),
    Status598(),
...
pub fn action_christmas_exchange_my_name_action_christmas_exchange_post(configuration: &configuration::Configuration, name: &str) -> Result<models::RewardDataResponseSchema, Error<ActionChristmasExchangeMyNameActionChristmasExchangePostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/my/{name}/action/christmas/exchange", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionChristmasExchangeMyNameActionChristmasExchangePostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn action_ge_buy_item_my_name_action_grandexchange_buy_post(configuration: &configuration::Configuration, name: &str, ge_buy_order_schema: models::GeBuyOrderSchema) -> Result<models::GeTransactionResponseSchema, Error<ActionGeBuyItemMyNameActionGrandexchangeBuyPostError>> {
    ...
    let local_var_uri_str = format!("{}/my/{name}/action/grandexchange/buy", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionGeBuyItemMyNameActionGrandexchangeBuyPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn action_ge_cancel_sell_order_my_name_action_grandexchange_cancel_post(configuration: &configuration::Configuration, name: &str, ge_cancel_order_schema: models::GeCancelOrderSchema) -> Result<models::GeTransactionResponseSchema, Error<ActionGeCancelSellOrderMyNameActionGrandexchangeCancelPostError>> {
    ...
    let local_var_uri_str = format!("{}/my/{name}/action/grandexchange/cancel", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionGeCancelSellOrderMyNameActionGrandexchangeCancelPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn action_ge_create_sell_order_my_name_action_grandexchange_sell_post(configuration: &configuration::Configuration, name: &str, ge_order_creationr_schema: models::GeOrderCreationrSchema) -> Result<models::GeCreateOrderTransactionResponseSchema, Error<ActionGeCreateSellOrderMyNameActionGrandexchangeSellPostError>> {
    ...
    let local_var_uri_str = format!("{}/my/{name}/action/grandexchange/sell", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionGeCreateSellOrderMyNameActionGrandexchangeSellPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn action_rest_my_name_action_rest_post(configuration: &configuration::Configuration, name: &str) -> Result<models::CharacterRestResponseSchema, Error<ActionRestMyNameActionRestPostError>> {
    ...
    let local_var_uri_str = format!("{}/my/{name}/action/rest", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionRestMyNameActionRestPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn action_use_item_my_name_action_use_post(configuration: &configuration::Configuration, name: &str, simple_item_schema: models::SimpleItemSchema) -> Result<models::UseItemResponseSchema, Error<ActionUseItemMyNameActionUsePostError>> {
    ...
    let local_var_uri_str = format!("{}/my/{name}/action/use", local_var_configuration.base_path, name=crate::apis::urlencode(name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionUseItemMyNameActionUsePostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
