...
pub fn action_change_skin_my_name_action_change_skin_post(configuration: &configuration::Configuration, name: &str, change_skin_character_schema: models::ChangeSkinCharacterSchema) -> Result<models::ChangeSkinResponseSchema, Error<ActionChangeSkinMyNameActionChangeSkinPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    let p_change_skin_character_schema = change_skin_character_schema;

    let uri_str = format!("{}/my/{name}/action/change_skin", configuration.base_path, name=crate::apis::urlencode(p_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_change_skin_character_schema);
...
pub fn action_deposit_bank_item_my_name_action_bank_deposit_item_post(configuration: &configuration::Configuration, name: &str, simple_item_schema: Vec<models::SimpleItemSchema>) -> Result<models::BankItemTransactionResponseSchema, Error<ActionDepositBankItemMyNameActionBankDepositItemPostError>> {
    ...
    let uri_str = format!("{}/my/{name}/action/bank/deposit/item", configuration.base_path, name=crate::apis::urlencode(p_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub fn action_give_gold_my_name_action_give_gold_post(configuration: &configuration::Configuration, name: &str, give_gold_schema: models::GiveGoldSchema) -> Result<models::GiveGoldReponseSchema, Error<ActionGiveGoldMyNameActionGiveGoldPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    let p_give_gold_schema = give_gold_schema;

    let uri_str = format!("{}/my/{name}/action/give/gold", configuration.base_path, name=crate::apis::urlencode(p_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_give_gold_schema);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GiveGoldReponseSchema`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GiveGoldReponseSchema`")))),
        }
    } else {
        let content = resp.text()?;
...
pub fn action_give_items_my_name_action_give_item_post(configuration: &configuration::Configuration, name: &str, give_items_schema: models::GiveItemsSchema) -> Result<models::GiveItemReponseSchema, Error<ActionGiveItemsMyNameActionGiveItemPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    let p_give_items_schema = give_items_schema;

    let uri_str = format!("{}/my/{name}/action/give/item", configuration.base_path, name=crate::apis::urlencode(p_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_give_items_schema);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GiveItemReponseSchema`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GiveItemReponseSchema`")))),
        }
    } else {
        let content = resp.text()?;
...
pub fn action_withdraw_bank_item_my_name_action_bank_withdraw_item_post(configuration: &configuration::Configuration, name: &str, simple_item_schema: Vec<models::SimpleItemSchema>) -> Result<models::BankItemTransactionResponseSchema, Error<ActionWithdrawBankItemMyNameActionBankWithdrawItemPostError>> {
    ...
    let uri_str = format!("{}/my/{name}/action/bank/withdraw/item", configuration.base_path, name=crate::apis::urlencode(p_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub fn get_character_logs_my_logs_name_get(configuration: &configuration::Configuration, name: &str, page: Option<i32>, size: Option<i32>) -> Result<models::DataPageLogSchema, Error<GetCharacterLogsMyLogsNameGetError>> {
    ...
    let uri_str = format!("{}/my/logs/{name}", configuration.base_path, name=crate::apis::urlencode(p_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
