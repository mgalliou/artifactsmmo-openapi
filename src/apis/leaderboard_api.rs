...
pub fn get_accounts_leaderboard_leaderboard_accounts_get(configuration: &configuration::Configuration, sort: Option<models::AccountLeaderboardType>, page: Option<i32>, size: Option<i32>) -> Result<models::DataPageAccountLeaderboardSchema, Error<GetAccountsLeaderboardLeaderboardAccountsGetError>> {
