...
impl FightSchema {
    pub fn new(xp: i32, gold: i32, drops: Vec<models::DropSchema>, turns: i32, monster_blocked_hits: models::BlockedHitsSchema, player_blocked_hits: models::BlockedHitsSchema, logs: Vec<String>, result: Result) -> FightSchema {
        FightSchema {
            xp,
            gold,
            drops,
