...
impl TaskFullSchema {
    pub fn new(code: String, level: i32, r#type: models::TaskType, min_quantity: i32, max_quantity: i32, skill: Option<String>, rewards: models::RewardsSchema) -> TaskFullSchema {
        TaskFullSchema {
            code,
            level,
            r#type,
