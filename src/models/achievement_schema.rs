...
impl AchievementSchema {
    pub fn new(name: String, code: String, description: String, points: i32, r#type: models::AchievementType, target: Option<String>, total: i32, rewards: models::AchievementRewardsSchema) -> AchievementSchema {
        AchievementSchema {
            name,
            code,
            description,
