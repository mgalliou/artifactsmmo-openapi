...
pub struct MyAccountDetails {
    ...
    pub badges: Option<Option<Vec<serde_json::Value>>>,
    /// Gems.
    #[serde(rename = "gems")]
    pub gems: i32,
    /// Achievement points.
...
impl MyAccountDetails {
    pub fn new(username: String, email: String, subscribed: bool, status: models::AccountStatus, gems: i32, achievements_points: i32, banned: bool) -> MyAccountDetails {
        MyAccountDetails {
            username,
            email,
            subscribed,
