...
impl BankItemTransactionSchema {
    pub fn new(cooldown: models::CooldownSchema, item: models::ItemSchema, bank: Vec<models::SimpleItemSchema>, character: models::CharacterSchema) -> BankItemTransactionSchema {
