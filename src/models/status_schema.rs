...
impl StatusSchema {
    pub fn new(version: String, server_time: String, max_level: i32, max_skill_level: i32, characters_online: i32, announcements: Vec<models::AnnouncementSchema>, rate_limits: Vec<models::RateLimitSchema>) -> StatusSchema {
        StatusSchema {
            version,
            server_time,
            max_level,
