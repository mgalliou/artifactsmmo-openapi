...
impl StatusSchema {
    pub fn new(status: String, max_level: i32, characters_online: i32, server_time: String, announcements: Vec<models::AnnouncementSchema>, last_wipe: String, next_wipe: String) -> StatusSchema {
        StatusSchema {
            status,
            version: None,
            max_level,
